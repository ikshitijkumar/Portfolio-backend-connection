        ...
        <div className="container">
          <div className="content">
            <div className="details">
              ...
              <div className="name">
                <h3>{data && data.user ? data.user.about.name : "name"}</h3>
              </div>
              <div className="job">
                <p>
                  A <span className="greenText">{data && data.user ? data.user.about.title : "Title"}</span>{" "}
                  From <span className="purpleText">{data && data.user ? data.user.about.address : "address"}</span>
                </p>
              </div>
              <div className="text">
                <p>{data && data.user ? data.user.about.description : "Description"}</p>
              </div>
            ...
            <div className="avatar">
              <div className="image">
                <img
                  src={data && data.user ? data.user.about.avatar.url : "/img/slider/avatar.png"}
                  alt="image"
                />
                {data &&
                  data.skills &&
